...
const DEFAULT_ACTIVITY_BAR_ORDER: ActivityBarItem[] = ['files', 'outline', 'search']
const ACTIVITY_BAR_REORDERABLE: readonly ActivityBarItem[] = ['files', 'outline', 'search']
const ACTIVITY_BAR_HIDEABLE: readonly ActivityBarItem[] = ['files', 'outline', 'search']
